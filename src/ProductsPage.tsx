...
const families = [
  {
    ...
    items: ['Business cards', 'Flyers', 'Brochures', 'Menus', 'Tags', 'Stationery'],
    image: brochureImage,
  ...
  },
  {
    ...
    items: ['Product cartons', 'Sleeves', 'Labels', 'Hang tags', 'Bakery packs', 'Retail packs'],
    image: cartonImage,
  ...
  },
  {
    ...
    items: ['Logos', 'Chest prints', 'Back prints', 'Uniform graphics', 'Merchandise', 'Gang sheets'],
    image: dtfImage,
  ...
  },
  {
    ...
    items: ['Odd sizes', 'Prototype runs', 'Mixed materials', 'Special finishing', 'Bulk jobs', 'Custom formats'],
    image: labelsImage,
